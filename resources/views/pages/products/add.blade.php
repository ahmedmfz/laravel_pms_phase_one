            ...
            <form role="form" action="{{ url('products')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  ...
                  <select name="category_id" class="form-control @error('category_id') is-invalid @enderror">
                    ...
                    <option value="empty" selected readonly>---</option>
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="qty" class="form-control @error('qty') is-invalid @enderror" value="{{ old('qty')}}" placeholder="Enter Quantity">
                  @error('qty')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
                ...
                <div class="form-group">
                  ...
                  <textarea name="description" class="form-control" placeholder="Description of product">{{ old('description')}}</textarea>
                </div><!-- /.quantity -->
